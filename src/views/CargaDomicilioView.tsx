...
import { postDomicilio } from '../API/SpecializedEndpoints/DomicilioRequests/DomicilioRequests';
...
const CargaDomicilioView: React.FC = () => {
  ...
  const handleSubmitDomicilio = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    // falta agregar el id del usuario en el domicilio
    try {
      console.log('Post domicilio');
      // postDomicilio(domicilio);
    } catch (error) {
