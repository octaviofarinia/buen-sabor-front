...
import { UserRouter } from './HeaderRouters/UserRouter';
import { EmployeeRouter } from './HeaderRouters/EmployeeRouter';
    ...
    <div className="flex h-20 w-full items-center bg-neutral-900 lg:p-6 ">
      <div className="w-100 flex w-full max-w-screen-2xl items-center justify-between px-4 md:px-8 ">
        <header className="flex w-full items-center justify-between py-4 md:py-8">
          ...
          <div className="-ml-8 hidden text-sm md:text-lg flex-col gap-2.5 sm:flex-row sm:justify-center lg:flex lg:justify-start">
          ...
          <button
            type="button"
            className="inline-flex items-center gap-2 rounded-lg bg-gray-200 px-2.5 py-2  font-semibold text-gray-500 ring-indigo-300 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base lg:hidden"
          >
            <svg
