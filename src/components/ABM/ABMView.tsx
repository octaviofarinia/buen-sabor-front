    ...
    <div className="flex w-full flex-col gap-5 px-32 pt-5">
      <div className="flex items-center justify-between">
        <h1 className="text-slate-950 flex items-center gap-3 text-3xl font-extrabold uppercase">
          <FontAwesomeIcon icon={faCubes} style={{ color: '#020617' }} />
          {tableName}
        </h1>
        <Link
      ...
      {tableData.length === 0 && (
        <h2 className="bg-rose-700 text-center font-semibold text-zinc-100 shadow-lg rounded-md p-2
        mt-3">
          Ups! Aun no has agregado ningún registro.
        </h2>
      )}

      <div className="my-6 flex flex-col gap-y-1 rounded-2xl shadow-2xl">
